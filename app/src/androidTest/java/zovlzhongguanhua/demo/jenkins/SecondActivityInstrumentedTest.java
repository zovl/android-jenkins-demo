...
public class SecondActivityInstrumentedTest {
    ...
    @Rule
    public ActivityTestRule mActivity = new ActivityTestRule(SecondActivity.class, false, true);
    ...
    public void testWrite() {
        ...
        ComponentName cn = new ComponentName("zovlzhongguanhua.demo.jenkins", "zovlzhongguanhua.demo.jenkins.SecondActivity");
